...
OUT_ROOT="${OUT_ROOT:-${SCRIPT_DIR}/output/dataset3}"

# 本地训练用的数据集 repo_id，训练时 --dataset.repo_id 要保持一致。
REPO_ID="${REPO_ID:-local/g1_wuji_2}"

# isaacteleop 录制出来的原始 session 目录。
RAW_DIR="${RAW_DIR:-${SMOLVLA_ROOT}/isaacteleop/examples/g1_wuji_teleop/data/dataset/20260705_221622}"
